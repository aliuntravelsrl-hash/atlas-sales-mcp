...
export function registerConsultarDisponibilidad(server, config) {
  server.tool(
    ...
    'Consulta disponibilidad y tarifas de un hotel Aliun Travel para fechas dadas. Retorna Core1 (rates) y Core2 (block inventory). SIEMPRE llamar antes de cotizar.',
    {
